...
// Generated on: 2013.07.31 at 02:36:01 PM BRT 
//

package org.nfe.xsd.pl6.leiauteConsultaCadastro;
 ...
 * 
 * <p>
 * Java class for TRetConsCad complex type.
 * 
 * <p>
...
public class TRetConsCad {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link TRetConsCad.InfCons }
	 * 
	 */
	 ...
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
	@XmlType(name = "", propOrder = { "verAplic", "cStat", "xMotivo", "uf",
			"ie", "cnpj", "cpf", "dhCons", "cuf", "infCad" })
	public static class InfCons {
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link TUfCons }
		 * 
		 */
		 ...
		 * <CODE>set</CODE> method for the infCad property.
		 * 
		 * <p>
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "ie", "cnpj", "cpf", "uf", "cSit",
				"indCredNFe", "indCredCTe", "xNome", "xFant", "xRegApur",
				"cnae", "dIniAtiv", "dUltSit", "dBaixa", "ieUnica", "ieAtual",
				"ender" })
