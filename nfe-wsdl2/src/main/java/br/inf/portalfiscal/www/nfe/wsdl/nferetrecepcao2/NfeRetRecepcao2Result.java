...
/**
 * NfeRetRecepcao2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeRetRecepcao2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetRecepcao2",
			"nfeRetRecepcao2Result", "ns7");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":nfeRetRecepcao2Result", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"nfeRetRecepcao2Result", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NfeRetRecepcao2Result parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			NfeRetRecepcao2Result object = new NfeRetRecepcao2Result();
						...
						if (!"nfeRetRecepcao2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeRetRecepcao2Result) br.inf.portalfiscal.www.nfe.wsdl.nferetrecepcao2.ExtensionMapper
