...
/**
 * NfeRecepcaoLote2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeRecepcaoLote2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeRecepcao2",
			"nfeRecepcaoLote2Result", "ns6");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":nfeRecepcaoLote2Result", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"nfeRecepcaoLote2Result", xmlWriter);
			}
						...
						if (!"nfeRecepcaoLote2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeRecepcaoLote2Result) br.inf.portalfiscal.www.nfe.wsdl.nferecepcao2.ExtensionMapper
