...
import org.nfe.commons.Federacao;
import org.nfe.commons.ProvedorServico;
import org.nfe.commons.Xsd;
import org.nfe.xsd.pl6.consStatServ.TConsStatServ;

/**
 * Classe para prover acesso aos serviços da Sefaz referentes 
...
public class Sefaz {
	...
	static final String VERSAO_ATUAL_NFE = new String("2.00");
	...
	public Sefaz(final CertificadoDigital certificadoDigital, final Federacao federacao, 
	...
	/**
	 * Consulta o status do serviço da Sefaz para o estado 
	 * informado na instanciação da classe.
	 * 
	 * @return Classe com informações do status da Sefaz.
	...
	public org.nfe.xsd.pl6.retConsStatServ.TRetConsStatServ getStatusServico() 
		...
		consulta.setVersao(VERSAO_ATUAL_NFE);
		...
		nfeCabecMsg.setVersaoDados(VERSAO_ATUAL_NFE);
		...
		br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.NfeStatusServico2Stub core;
		try {
			core = new br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2
		...
		try {
			resultadoConsulta = core.nfeStatusServicoNF2(dadosMsg, cabecMsg);
	...
	/**
	 * Carrega um objeto da NF-e de com base em um arquivo XML.
	 * A própria operação de carregar o arquivo já o valida com o layout
	 * da nf-e, caso o arquivo não seja válido, uma exceção será criada.
	 *  
	 * @param file Arquivo XML da nota já processada.
	 * @return Objeto representando a nota fiscal.
	 * @throws SefazOperationException 
	 */	
	public org.nfe.xsd.pl6.procNFe.TNfeProc getNFProcessada(
			final InputStream file) throws SefazOperationException {
		try {
			return Xsd.doReadFile(file).getObject(org.nfe.xsd.pl6.procNFe.TNfeProc.class);
		} catch (JAXBException e) {
			throw new SefazOperationException(e.getMessage());
		}
	}
	...
	/**
	 * Gera uma saída textual do arquivo xml com base em um objeto já processado.
	 * 
	 * @param nfeProcessada Objeto da nota fiscal já processada.
	 * @param arquivoRetorno Saída textual, pode ser um arquivo texto ou uma 
	 * 	escrita no próprio console (System.out).  
	 * @throws SefazOperationException 
	 */
	public void doGeraArquivoRetorno(org.nfe.xsd.pl6.procNFe.TNfeProc nfeProcessada, 
