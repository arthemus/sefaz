...
import org.nfe.xsd.pl6.procNFe.TNFe.InfNFe.Det.Imposto.ICMS.ICMS70;
 ...
 * @since 14/08/2013
 */
public class ICMS70Adapter extends ICMSAdapter {

	private final ICMS70 icms;

	public ICMS70Adapter(TNFe.InfNFe.Det.Imposto.ICMS.ICMS70 icms) {
		this.icms = icms;
	}
