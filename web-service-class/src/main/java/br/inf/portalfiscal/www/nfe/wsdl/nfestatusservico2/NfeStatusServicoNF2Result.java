...
/**
 * NfeStatusServicoNF2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeStatusServicoNF2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2",
			"nfeStatusServicoNF2Result", "ns2");
						...
						if (!"nfeStatusServicoNF2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeStatusServicoNF2Result) br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.ExtensionMapper
