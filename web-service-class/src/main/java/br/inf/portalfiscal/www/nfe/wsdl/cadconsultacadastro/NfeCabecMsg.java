...
/**
 * NfeCabecMsg bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NfeCabecMsg parse(javax.xml.stream.XMLStreamReader reader)
						...
						if (!"nfeCabecMsg".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeCabecMsg) br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro.ExtensionMapper
