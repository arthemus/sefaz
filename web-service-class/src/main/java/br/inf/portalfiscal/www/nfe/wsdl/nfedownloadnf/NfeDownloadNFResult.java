...
/**
 * NfeDownloadNFResult bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeDownloadNFResult implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeDownloadNF",
			"nfeDownloadNFResult", "ns1");
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":nfeDownloadNFResult", xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"nfeDownloadNFResult", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NfeDownloadNFResult parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			NfeDownloadNFResult object = new NfeDownloadNFResult();
						...
						if (!"nfeDownloadNFResult".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeDownloadNFResult) br.inf.portalfiscal.www.nfe.wsdl.nfedownloadnf.ExtensionMapper
