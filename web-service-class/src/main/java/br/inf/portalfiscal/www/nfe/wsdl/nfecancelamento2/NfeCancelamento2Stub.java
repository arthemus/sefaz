...
public class NfeCancelamento2Stub extends org.apache.axis2.client.Stub
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"NfeCancelamento2" + getUniqueSuffix());
	 ...
	 */
	public NfeCancelamento2Stub(java.lang.String targetEndpoint)
			throws org.apache.axis2.AxisFault {
	...
	public br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result nfeCancelamentoNF2(
			...
			br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeDadosMsg nfeDadosMsg3,
			br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCabecMsgE nfeCabecMsg4)
...

	{
		...
		try {
			...
			java.lang.Object object = fromOM(
					...
					br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result.class,
					getEnvelopeNamespaces(_returnEnv));

			return (br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result) object;
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(
								faultElt.getQName(), "nfeCancelamentoNF2"))) {
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					...
					public void onMessage(
						...
						try {
							...
							callback.receiveResultnfeCancelamentoNF2((br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap
									...
									try {
										...
										callback.receiveErrornfeCancelamentoNF2(new java.rmi.RemoteException(
												ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeDadosMsg param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private org.apache.axiom.om.OMElement toOM(
			br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCabecMsgE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCabecMsgE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeDadosMsg.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeDadosMsg.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCancelamentoNF2Result.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCabecMsgE.class
					.equals(type)) {

				return br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.NfeCabecMsgE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
