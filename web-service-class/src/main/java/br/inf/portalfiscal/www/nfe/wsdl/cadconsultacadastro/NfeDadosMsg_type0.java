...
/**
 * NfeDadosMsg_type0 bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeDadosMsg_type0 implements org.apache.axis2.databinding.ADBBean {
	/*
						...
						if (!"nfeDadosMsg_type0".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeDadosMsg_type0) br.inf.portalfiscal.www.nfe.wsdl.cadconsultacadastro.ExtensionMapper
