...
/**
 * NfeRecepcao2CallbackHandler Callback class, Users can extend this class and
...
public abstract class NfeRecepcao2CallbackHandler {
	 ...
	 * override this method for handling normal response from nfeRecepcaoLote2
	 * operation
	 */
	public void receiveResultnfeRecepcaoLote2(
			br.inf.portalfiscal.www.nfe.wsdl.nferecepcao2.NfeRecepcaoLote2Result result) {
	}

	/**
	 * auto generated Axis2 Error handler override this method for handling
	 * error response from nfeRecepcaoLote2 operation
	 */
