...
/**
 * NfeCancelamentoNF2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeCancelamentoNF2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeCancelamento2",
			"nfeCancelamentoNF2Result", "ns3");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"nfeCancelamentoNF2Result", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NfeCancelamentoNF2Result parse(
						...
						if (!"nfeCancelamentoNF2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeCancelamentoNF2Result) br.inf.portalfiscal.www.nfe.wsdl.nfecancelamento2.ExtensionMapper
