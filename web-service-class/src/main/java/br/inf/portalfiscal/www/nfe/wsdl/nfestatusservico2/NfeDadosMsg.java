...
/**
 * NfeDadosMsg bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static NfeDadosMsg parse(javax.xml.stream.XMLStreamReader reader)
						...
						if (!"nfeDadosMsg".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeDadosMsg) br.inf.portalfiscal.www.nfe.wsdl.nfestatusservico2.ExtensionMapper
