...
/**
 * NfeConsultaNF2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeConsultaNF2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2",
			"nfeConsultaNF2Result", "ns4");
						...
						if (!"nfeConsultaNF2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeConsultaNF2Result) br.inf.portalfiscal.www.nfe.wsdl.nfeconsulta2.ExtensionMapper
