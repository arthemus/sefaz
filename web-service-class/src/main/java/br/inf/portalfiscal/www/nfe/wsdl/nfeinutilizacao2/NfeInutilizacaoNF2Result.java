...
/**
 * NfeInutilizacaoNF2Result bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class NfeInutilizacaoNF2Result implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2",
			"nfeInutilizacaoNF2Result", "ns5");
						...
						if (!"nfeInutilizacaoNF2Result".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (NfeInutilizacaoNF2Result) br.inf.portalfiscal.www.nfe.wsdl.nfeinutilizacao2.ExtensionMapper
