...
/**
 * Implementação padrão para um certificado digital.
 * 
 * @author arthemus
 * @since 05/08/2013
 */
public class DefaultCertificadoDigital implements CertificadoDigital {
	...
	public DefaultCertificadoDigital(InputStream arquivoCertificado, 
	...
	@Override
	public InputStream getArquivoCacert() {
